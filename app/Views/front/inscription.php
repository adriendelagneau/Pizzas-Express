...
<main class="contact">
    ...
    <p>Commander au 02 97 27 12 **<p>
            ...
            <form action="index.php?action=inscription" method="post" id="inscription">
                    ...
                    <span class="error">
                        <?php if(isset($errors["required_userPhone"])){echo $errors["required_userPhone"]; }?>
                    </span>
                    ...
                    <span class="error">
                        <?php if(isset($errors["required_PWD"])){echo $errors["required_PWD"]; }?>
                    </span>
